const TOWER_MAP_DATA = [
    ...
    },
    {
        ...
        squares: {
            'f19-s':  { type: 'start' },
            'f19-bl1': { type: 'battle', enemies: ['オーク哨戒部隊長',  'ユグドラシル'], rules: ['毎ターン終了時、覚醒+10'] },
            'f19-br1': { type: 'battle', enemies: ['オーク哨戒部隊長', 'イカロエン', ], rules: ['毎ターン終了時、覚醒+10'] },
            'f19-bs1': { type: 'battle', enemies: ['オーク哨戒部隊長', 'ウィチセ', 'イカロエン'], rules: ['毎ターン終了時、覚醒+10'] },
            'f19-el1': {  type: 'explore', sub_type: 'status_buff', style: 'R' },
            'f19-er1': {  type: 'explore', sub_type: 'status_buff', style: 'B' },
            'f19-bl2': { type: 'battle', enemies: ['オーク哨戒部隊長', 'イカロエン'], rules: ['毎ターン終了時、覚醒+10'] },
            'f19-br2': { type: 'battle', enemies: ['アビスハンター', 'ユグドラシル'], rules: ['毎ターン終了時、覚醒+10'] },
            'f19-bs2': { type: 'battle', enemies: ['オーク哨戒部隊長',  'ユグドラシル'], rules: ['毎ターン終了時、覚醒+10'] },
            'f19-bl3': { type: 'battle', enemies: ['オーク哨戒部隊長',  'ユグドラシル'], rules: ['毎ターン終了時、覚醒+10'] },
            'f19-br3': { type: 'battle', enemies: ['オーク哨戒部隊長', 'ウィチセ', 'イカロエン'], rules: ['毎ターン終了時、覚醒+10'] },
    ...
    },
    {
        ...
        squares: {
            ...
            'f20-bs1': { type: 'battle', enemies: ['オーク哨戒部隊長','アビスハンター','ユグドラシル'], rules: ['毎ターン終了時、HP30%回復（幻獣）'] },
            'f20-br1': { type: 'battle', enemies: ['ウィチセ','イカロエン'], rules: ['毎ターン終了時、HP30%回復（幻獣）'] },
            'f20-es1': { type: 'explore', sub_type: 'attack_buff', style: 'C' },
            'f20-el2': { type: 'explore', sub_type: 'hp_buff', style: 'C' },
            'f20-bl2': { type: 'battle', enemies: ['オーク哨戒部隊長','ウィチセ','イカロエン'], rules: ['毎ターン終了時、HP30%回復（幻獣）'] },
            'f20-br2': { type: 'battle', enemies: ['オーク哨戒部隊長','アビスハンター','ユグドラシル'], rules: ['毎ターン終了時、HP30%回復（幻獣）'] },
            'f20-er2': { type: 'explore', sub_type: 'defense_buff', style: 'C' },
            'f20-bl3': { type: 'battle', enemies: ['オーク哨戒部隊長','イカロエン'], rules: ['毎ターン終了時、HP30%回復（幻獣）'] },
            'f20-br3': { type: 'battle', enemies: ['オーク哨戒部隊長','アビスハンター','ユグドラシル'], rules: ['毎ターン終了時、HP30%回復（幻獣）'] }, 
            'f20-bl4': { type: 'battle', enemies: ['オーク哨戒部隊長','アビスハンター','ユグドラシル'], rules: ['毎ターン終了時、HP30%回復（幻獣）'] },
            'f20-bs2': { type: 'battle', enemies: ['オーク哨戒部隊長','ウィチセ'], rules: ['毎ターン終了時、HP30%回復（幻獣）'] },
            'f20-br4': { type: 'battle', enemies: ['オーク哨戒部隊長','ユグドラシル'], rules: ['毎ターン終了時、HP30%回復（幻獣）'] },
    ...
    // 21F-25F
    {
        ...
        squares: {
            'f21-s':  { type: 'start' },
            'f21-bl1': { type: 'battle', enemies: ['ブタゴラス','イコア','リリィ'], rules: ['毎ターン終了時、覚醒+1（幻獣）'] },
            'f21-br1': { type: 'battle', enemies: ['ホルン','ドカグイ','ケラヴノス'], rules: ['毎ターン終了時、覚醒+1（幻獣）'] },
            'f21-bl2': { type: 'battle', enemies: ['ドカグイ'], rules: ['毎ターン終了時、覚醒+1（幻獣）'] },
            'f21-br2': { type: 'battle', enemies: ['ブタゴラス','イコア','リリィ'], rules: ['毎ターン終了時、覚醒+1（幻獣）'] },
            ...
            'f21-bl4': { type: 'battle', enemies: ['ブタゴラス','イコア','リリィ'], rules: ['毎ターン終了時、覚醒+1（幻獣）'] },
            'f21-br4': { type: 'battle', enemies: ['ホルン','ドカグイ','ケラヴノス'], rules: ['毎ターン終了時、覚醒+1（幻獣）'] },
            'f21-bl5': { type: 'battle', enemies: ['ホルン','ドカグイ','ケラヴノス'], rules: ['毎ターン終了時、覚醒+1（幻獣）'] },
            'f21-br5': { type: 'battle', enemies: ['ブタゴラス','イコア','リリィ'], rules: ['毎ターン終了時、覚醒+1（幻獣）'] },
    ...
    },
    {
        ...
        squares: {
            ...
            'f22-bl1': { type: 'battle', enemies: ['ブタゴラス','イコア','リリィ'], rules: ['毎ターン終了時、1回バリア（幻獣）'] },
            'f22-br1': { type: 'battle', enemies: ['ケラヴノス','ホルン'], rules: ['毎ターン終了時、1回バリア（幻獣）'] },
            'f22-bl2': { type: 'battle', enemies: ['ホルン','ドカグイ','ケラヴノス'], rules: ['毎ターン終了時、1回バリア（幻獣）'] },
            'f22-br2': { type: 'battle', enemies: ['ブタゴラス','リリィ'], rules: ['毎ターン終了時、1回バリア（幻獣）'] },
            'f22-bl3': { type: 'battle', enemies: ['バルガリオ','メイドゥーム','ファロオース'], rules: ['毎ターン終了時、1回バリア（幻獣）'] },
            'f22-br3': { type: 'battle', enemies: ['バルガリオ','メイドゥーム','リリィ','ファロオース'], rules: ['毎ターン終了時、1回バリア（幻獣）'] },
            'f22-bl4': { type: 'battle', enemies: ['イコア','リリィ'], rules: ['毎ターン終了時、1回バリア（幻獣）'] },
            'f22-br4': { type: 'battle', enemies: ['ホルン','ドカグイ'], rules: ['毎ターン終了時、1回バリア（幻獣）'] },
            'f22-bl5': { type: 'battle', enemies: ['ホルン','ドカグイ','ケラヴノス'], rules: ['毎ターン終了時、1回バリア（幻獣）'] },
            'f22-br5': { type: 'battle', enemies: ['ブタゴラス','リリィ'], rules: ['毎ターン終了時、1回バリア（幻獣）'] },
    ...
    },
    {
        ...
        squares: {
            ...
            'f24-bl1': { type: 'battle', enemies: ['ブタゴラス','イコア','リリィ'], rules: ['被ダメージ20%上昇（メギド）'] },
            'f24-br1': { type: 'battle', enemies: ['ドカグイ','ケラヴノス'], rules: ['被ダメージ20%上昇（メギド）'] },
            'f24-bl2': { type: 'battle', enemies: ['ドカグイ','ケラヴノス'], rules: ['被ダメージ20%上昇（メギド）'] },
            'f24-br2': { type: 'battle', enemies: ['ブタゴラス','イコア'], rules: ['被ダメージ20%上昇（メギド）'] },
            'f24-bl3': { type: 'battle', enemies: ['ホルン','イカロエン'], rules: ['被ダメージ20%上昇（メギド）'] },
            'f24-br3': { type: 'battle', enemies: ['ウィチセ','ホルン','イカロエン'], rules: ['被ダメージ20%上昇（メギド）'] },
            'f24-bl4': { type: 'battle', enemies: ['イコア','リリィ'], rules: ['被ダメージ20%上昇（メギド）'] },
            'f24-br4': { type: 'battle', enemies: ['ドカグイ','ケラヴノス'], rules: ['被ダメージ20%上昇（メギド）'] },
            'f24-bl5': { type: 'battle', enemies: ['ドカグイ','ケラヴノス'], rules: ['被ダメージ20%上昇（メギド）'] },
            'f24-br5': { type: 'battle', enemies: ['ブタゴラス','リリィ'], rules: ['被ダメージ20%上昇（メギド）'] },
    ...
    },
    {
        ...
        squares: {
            ...
            'f25-bs1': { type: 'battle', enemies: ['ウィチセ','ホルン','イカロエン'], rules: ['素早さ100%低下'] },
            'f25-bs2': { type: 'battle', enemies: ['イコア','リリィ'], rules: ['素早さ100%低下'] },
            'f25-bl1': { type: 'battle', enemies: ['ブタゴラス','イコア','リリィ'], rules: ['素早さ100%低下'] },
            'f25-bl2': { type: 'battle', enemies: ['ブタゴラス','イコア'], rules: ['素早さ100%低下'] },
            'f25-bl3': { type: 'battle', enemies: ['ドカグイ','ケラヴノス'], rules: ['素早さ100%低下'] },
            'f25-bl4': { type: 'battle', enemies: ['ウィチセ','イカロエン'], rules: ['素早さ100%低下'] },
            'f25-br1': { type: 'battle', enemies: ['ドカグイ','朧の闇','ケラヴノス'], rules: ['素早さ100%低下'] },
            'f25-br2': { type: 'battle', enemies: ['ウィチセ','ホルン','イカロエン'], rules: ['素早さ100%低下'] },
            'f25-br3': { type: 'battle', enemies: ['ブタゴラス','リリィ'], rules: ['素早さ100%低下'] },
    ...
    // 31F-35F
    {
        ...
        squares: {
            'f31-s':  { type: 'start' },
            'f31-bs1': { type: 'battle', enemies: ['ディヴァガル（ 31階 ）','ギガンテス（ 31階 ）','ネイロード（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-bl1': { type: 'battle', enemies: ['火のザウラク（ 31階 ）','水のクルサ（ 31階 ）','雷のアザー（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-br1': { type: 'battle', enemies: ['ディヴァガル（ 31階 ）','ギガンテス（ 31階 ）','ネイロード（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-bl2': { type: 'battle', enemies: ['アシュトレト（ 31階 ）','ガオケレナ（ 31階 ）','死を育む者（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-br2': { type: 'battle', enemies: ['ディヴァガル（ 31階 ）','ギガンテス（ 31階 ）','ネイロード（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-bl3': { type: 'battle', enemies: ['ディヴァガル（ 31階 ）','ギガンテス（ 31階 ）','ネイロード（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            ...
            'f31-br4': { type: 'battle', enemies: ['アシュトレト（ 31階 ）','ガオケレナ（ 31階 ）','死を育む者（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-bl5': { type: 'battle', enemies: ['アシュトレト（ 31階 ）','ガオケレナ（ 31階 ）','死を育む者（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-br5': { type: 'battle', enemies: ['ディヴァガル（ 31階 ）','ギガンテス（ 31階 ）','ネイロード（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-bl6': { type: 'battle', enemies: ['火のザウラク（ 31階 ）','水のクルサ（ 31階 ）','雷のアザー（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-br6': { type: 'battle', enemies: ['アシュトレト（ 31階 ）','ガオケレナ（ 31階 ）','死を育む者（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-bl7': { type: 'battle', enemies: ['アシュトレト（ 31階 ）','ガオケレナ（ 31階 ）','死を育む者（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
            'f31-br7': { type: 'battle', enemies: ['ディヴァガル（ 31階 ）','ギガンテス（ 31階 ）','ネイロード（ 31階 ）'], rules: ['進化度・レベル制限：⭐︎2.5/Lv23'] },
    ...
    },
    {
        ...
        squares: {
            ...
            'f32-bl2': { type: 'battle', enemies: ['バリバリアン','ガオケレナ','死を育む者'], rules: ['特殊フォトン発生'] },
            ...
            'f32-bl5': { type: 'battle', enemies: ['バリバリアン','ガオケレナ','死を育む者'], rules: ['特殊フォトン発生'] },
            'f32-bl6': { type: 'battle', enemies: ['アフロンタレング','ノラモデウス','ドラギナッツオ'	], rules: ['特殊フォトン発生'] },
            'f32-bl7': { type: 'battle', enemies: ['バリバリアン','ガオケレナ','死を育む者'], rules: ['特殊フォトン発生'] },
            ...
            'f32-br3': { type: 'battle', enemies: ['バリバリアン','ガオケレナ','死を育む者'], rules: ['特殊フォトン発生'] },
    ...
    },
    {
        ...
        squares: {
            ...
            'f33-bl2': { type: 'battle', enemies: ['ガオケレナ','死を育む者'], rules: ['劣化フォトン発生'] },
            ...
            'f33-bl5': { type: 'battle', enemies: ['バリバリアン','ガオケレナ'], rules: ['劣化フォトン発生'] },
            ...
            'f33-br3': { type: 'battle', enemies: ['バリバリアン','ガオケレナ'], rules: ['劣化フォトン発生'] },
    ...
    },
    {
        ...
        squares: {
            ...
            'f34-br6': { type: 'battle', enemies: ['バリバリアン','ガオケレナ'], rules: ['全能力+20%（幻獣）'] },
    ...
    },
    {
        ...
        squares: {
            ...
            'f35-bl3': { type: 'battle', enemies: ['バリバリアン','ガオケレナ','死を育む者'], rules: ['スキル強化'] },
            ...
            'f35-br2': { type: 'battle', enemies: ['バリバリアン','ガオケレナ'], rules: ['スキル強化'] },
            'f35-br3': { type: 'battle', enemies: ['ギガンテス','マセタン'	], rules: ['スキル強化'] },
            'f35-br4': { type: 'battle', enemies: ['バリバリアン','ガオケレナ','死を育む者'], rules: ['スキル強化'] },
